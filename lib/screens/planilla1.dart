    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (context) {
          return pw.Column(
            children: [
              pw.Text('Levantamiento de informacion general ',// Título de la plantilla
              ...
              child: Form(
                ...
                child: ListView(
                  children: [
                    ...
                    _buildTextField('Soporte de Retencion 144H', _sr144hController),
                    _buildTextField('Soporte de Retencion', _sr12hController),
                    _buildTextField('Soporte de Suspension 144H', _ss144hController),
                    _buildTextField('Soporte de Suspension 12H', _ss12hController),
                    ...
                    _buildDropdownField('Tirraje / Fleje', _tirrajeFleje, ['Tirraje', '1 Fleje', '2 Fleje', 'Otro'], (val) {
